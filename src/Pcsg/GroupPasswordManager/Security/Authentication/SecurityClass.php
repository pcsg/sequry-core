...
class SecurityClass extends QUI\QDOM
{
     ...
     * @return array
     */
    public function searchEligibleActors($searchParams, $type)
    {
        switch ($type) {
            case 'groups':
                $actors = $this->searchEligibleGroups($searchParams);
                break;

            // users
            default:
                $actors = $this->searchEligibleUsers($searchParams);
                break;
        }
    ...
    public function searchEligibleUsers($searchParams, $countOnly = false)
    {
    ...
    public function searchEligibleGroups($searchParams)
    {
